...
export default function CeoProfile({ ceo }: ceoType) {
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <div className="mb-5">
              ...
              Nigeria (MASPN), and a certified Lead Auditor for ISO 9001:2015
              and FSSC 22000.
            </div>
            ...
            {expanded && (
              <div className="space-y-5 text-[var(--foreground)]/80">
                <div>
                  Mr. Oresanya began his career at Procter & Gamble Nigeria as a
                  Quality Analyst, later becoming the Quality Control Leader of
                  the Ibadan Plant. In 2013, he joined PZ Cussons Nigeria PLC as
                  Quality Assurance Manager, rising to Africa Quality Systems
                  Manager and ISO 9001:2015 Representative.
                </div>

                <div>
                  He has been instrumental in achieving ISO certifications and
                  building sustainable quality infrastructures across operations
                  in Africa. He currently serves as Head of Quality and Quality
                  Systems Manager for Africa at PZ Cussons.
                </div>
                ...
                <div>
                  ...
                  , Mr. Oresanya leads with integrity, regulatory insight, and a
                  performance-driven vision—ensuring every client engagement
                  translates into measurable impact and compliance excellence.
                </div>
              </div>
            )}
