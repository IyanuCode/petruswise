...
export default function StaffSection({ staffData }: staffSectionProps) {
  ...
  return (
    <TooltipProvider>
          ...
          {staffData.map((staff, index) => (
            ...
            >
              ...
              <div className="relative w-full h-56 overflow-hidden group">
                <Image
                  src={
                    staff.imageUrl && staff.imageUrl.trim() !== ""
                      ? staff.imageUrl
                      : "/awotiku.jpg"
                  }
                  alt={staff.name}
      ...
      {/* =============== CTA =============== */}
      <section className="py-20 px-6 md:px-12 bg-gradient-to-b from-[var(--brand-gold)] to-[var(--brand-black)]/5 text-[var(--brand-black)] text-center">
