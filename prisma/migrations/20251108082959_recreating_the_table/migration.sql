...
INSERT INTO "new_ContactInfo" ("contactInfo", "contactPageId", "id", "imageUrl", "name", "role") SELECT "contactInfo", "contactPageId", "id", "imageUrl", "name", "role" FROM "ContactInfo";
...
INSERT INTO "new_ContactPage" ("address", "email", "heroImage", "heroParagraph", "heroTitle", "id", "phone", "slug", "talkDescription", "talkTitle", "updatedAt") SELECT "address", "email", "heroImage", "heroParagraph", "heroTitle", "id", "phone", "slug", "talkDescription", "talkTitle", "updatedAt" FROM "ContactPage";
